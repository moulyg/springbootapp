...
import com.topcoder.api.repositories.RolesRepository;
...
public class UserService extends BaseService {
  ...
  public void init() {
    ...
    Utils.checkNull(rolesRepository, "rolesRepository");
  }
  ...
  public User create(UserRequest request) {
    ...
    if(!department.isPresent()) {
      throw new EntityNotFoundException(String.format("The department id '%s' is not found", request.getDepartmentId()));
    } else {
